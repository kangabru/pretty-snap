...
import { getSizeBackground } from '../../pretty-background/hooks/use-styles';
import { urls } from '../../pretty-background/misc/constants';
import { getImageSrcDownload } from '../../pretty-background/misc/utils';
import useOptionsStore from '../../pretty-background/stores/options';
