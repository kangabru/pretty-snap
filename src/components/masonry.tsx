...
function SearchInput() {
    ...
    return <div class="row justify-center sm:justify-start space-x-2">
        ...
        <input disabled={isSearching} onKeyUp={update} value={newTerm ?? ""} type="text" placeholder="Search unsplash.com"
            class="px-3 py-2 border-b-2 border-gray-200 focus:border-primary-light outline-none disabled:opacity-50 disabled:bg-gray-100 rounded transition" />
    </div>
}
