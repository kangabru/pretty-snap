...
export default function Patterns() {
    ...
    return <div ref={ref} className="grid grid-rows-1 grid-flow-col gap-2 p-2 overflow-x-scroll" tabIndex={-1}>
...
function Pattern({ getSrc }: { getSrc: SvgPatternCallback }) {
    ...
    return <button data-target={isTarget} onClick={onClick} className="relative w-24 h-24 rounded outline-primary" style={{ backgroundColor: bg?.bgColour ?? "black" }}>
