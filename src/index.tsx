...
function PrettySnap() {
    return <div class="flex flex-col space-y-12 text-gray-800 bg-gray-50 font-open min-h-screen">
        <Header />
    ...
    return <>
        <section class="flex-1 col justify-center space-y-5">
            <h2 class="text-2xl">
                ...
                <span>with these simple editing apps</span>
            </h2>
        ...
        <div class="col-span-2 w-full text-center row justify-center">
            <a href={routes.home} class="outline-primary rounded">
                <h1 class="row text-4xl font-cursive p-1 pr-2 space-x-3">
                    <img src={srcLogo} alt="Panda Snap Logo" class="hidden sm:inline-block w-10 h-10 rounded-md overflow-hidden pointer-events-none" />
...
function Footer() {
    return <footer class="pb-10 text-center space-y-3">
